...
function EnhancedTableToolbar(props) {
    const { numSelected, selected, handleBlock } = props;
    ...
    return (
        ...
        >
            ...
            {numSelected > 0 ? (
                <Tooltip title="חסימת משתמש/ים">
                    <IconButton onClick={() => handleBlock(selected)} >
                        <BlockIcon />
                    </IconButton>
                </Tooltip>
            ) : (
...
export default function EnhancedTable({ allUsers, handleBlock }) {
    ...
    const handleSelectAllClick = (event) => {
        if (event.target.checked) {
            const newSelected = allUsers.map((n) => n.userId);
                                ...
                                return (
                                    ...
                                    >
                                        <TableCell padding="checkbox">
                                            ...
                                            // onChange={(e) => { handleChange(e, index, row.freelanceId) }}
                                            />
                                        </TableCell>
                                        <TableCell
                                            align="center"
